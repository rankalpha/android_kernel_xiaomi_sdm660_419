...
static unsigned int get_update_sysctl_factor(void)
{
    ...
    return (sysctl_sched_tunable_scaling == SCHED_TUNABLESCALING_LINEAR) ? cpus : (1 + ilog2(cpus));
}
